...
public class ModPlacedFeatures {
    public static final ResourceKey<PlacedFeature> SALT_BLOCK_PLACED_KEY = createKey("salt_block_placed");

    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        HolderGetter<ConfiguredFeature<?, ?>> configuredFeatures = context.lookup(Registries.CONFIGURED_FEATURE);

        register(context, SALT_BLOCK_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.SALT_BLOCK_KEY),
